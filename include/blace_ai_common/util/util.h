...
/**
 * @brief Registers a model defined in a .blacemodel file on disk.
...
EXPORT_OR_IMPORT std::optional<ml_core::ModelIdent>
registerModel(std::string model_message_file,
              std::filesystem::path model_folder);

/**
 * @brief Registers a model defined in bytes stored in a header.
