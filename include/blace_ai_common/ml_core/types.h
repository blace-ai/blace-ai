...
enum class ReturnCode {
  OK = 0,
  Error,         // Returned on generic errors
  UserCancelled, // This will be returned if a callback passed to the evaluator
                 // signalled cancelation.
  MissingData,   // Returned if missing data was encountered during computation
  Error_OOM,     // Returned if method run into an OOM situation
  ModelFileNotPresent
};
