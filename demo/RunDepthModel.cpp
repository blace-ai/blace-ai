...
cv::Mat blace::testing::runDepthModel() {
  ::blace::workload_management::BlaceWorld blace;
  ...
  auto interpolated = CONSTRUCT_OP(blace::ops::Interpolate2DOp(
  ...
  auto result_depth = CONSTRUCT_OP(blace::ops::NormalizeToZeroOneOP(infer_op));
